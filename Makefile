...
SRCS := DPMM.c DensityOutput.c PolyaUrnDPMM.c PosteriorDensityOutput.c PredictiveDensityOutput.c WalkerDPMM.c
SRCS := $(SRCS) csv_helpers.c helpers.c read_data.c sort.c write_data.c work.c
