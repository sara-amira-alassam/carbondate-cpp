...
public:
    ...
    DensityOutput get_posterior_calendar_age_density(int output_offset, int ident, int resolution);
    DensityOutput get_single_calendar_age_likelihood(int output_offset, int ident, int resolution);
